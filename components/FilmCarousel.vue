...
{
    title:"The Creator",
    text:"The Creator Test",
    imgName:"poster.jpg"
},
{
    title:"Oppenheimer",
    text:"Oppenheimer test",
    imgName:"poster1.webp"
},
{
    title:"Interstellar",
    text:"Interstellar test",
    imgName:"poster3.jpg"
}
]
...
<template>
    <div id="filmCarousel" class="w-full flex shrink-0 flex-col items-center h-[60%]">
